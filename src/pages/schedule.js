...
//   // Use useTransform to map scrollY to a transform value
//   const transform = useTransform(scrollY, [0, pageHeight], [0, -pageHeight]);

//   // Use spring for smooth scrolling with damping, mass, and stiffness
...
//           ref={scrollRef}
//           style={{ y: spring }}
//           className="col-span-2 space-y-6 max-h-[calc(100vh-50px)] overflow-y-auto no-scrollbar scroll-container"
